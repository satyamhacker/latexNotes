...
6. **Protect Markdown Links:** Be careful with existing markdown syntax like links `[text](url)`. If highlighting text inside a link, place the tags strictly around the text: `[[HL::text::HL]]` without breaking the `[]()` structure.
